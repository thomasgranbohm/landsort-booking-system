...
# Users
curl localhost:8080/users -X POST -d "email=thomas.granbohm@gmail.com&firstname=Thomas&lastname=Granbohm&phonenumber=0736761614"
...
# Bookings
curl localhost:8080/bookings -X POST -H "Content-Type: application/json" --data-raw '{"bunks":[2, 4, 6], "start_date": "2021-01-01", "end_date": "2021-01-06", "user_email": "thomas.granbohm@gmail.com"}'
